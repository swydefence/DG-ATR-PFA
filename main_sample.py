...
def main(args: argparse.Namespace):
    ...
    # Data loading code
    train_transform = train_utils.get_train_transform(args.train_resizing, random_horizontal_flip=True,
                                                random_color_jitter=True, random_gray_scale=True)
    val_transform = train_utils.get_val_transform(args.val_resizing)
